...
public class ServidorWeb1 {
    ...
    public class Manejador extends Thread {
        ...
        public void delA(String arg, String headers) {
            try {
        ...
        public void sendA(String arg, int bandera) {
            try {
                File f = new File(arg);
        ...
        public String getA(String line) {
        ...
        public String getP(String line, String headers, int bandera) {
            String metodo = "POST";
            ...
            String html = headers +
                "<html><head><meta charset='UTF-8'><title>Método " + metodo + "\n" +
                "</title></head><body bgcolor='#7A7CFF'><center><h2>Parámetros orecuperados a través de solicitud: " + metodo + "</h2><br>\n" +
            ...
            try {
                ...
                if (line == null) {
                    ...
                    if (line.toUpperCase().startsWith("GET")) {
                        ...
                        // Bandera GET = 0, POST = 1
                        String respuesta = getP(reqLineas[ult], headers, 1);
